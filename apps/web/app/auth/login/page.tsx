...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!orgslug) {
    // Apex (org-less) login.
    return { title: "Login — St. Joseph's Placements and Training Cell", robots: { index: false, follow: false } }
  }
  ...
  return {
    title: 'Login' + ` — ${org?.name || "St. Joseph's Placements and Training Cell"}`,
