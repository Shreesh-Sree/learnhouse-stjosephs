...
export const ERROR_CATALOG: ErrorCategory[] = [
  {
    ...
    description:
      "A new version of St. Joseph's Placements and Training Cell was released while this page was open, so it briefly fell out of sync. Reloading will pick up the latest version.",
    matchers: {
      statuses: [],
      messageIncludes: [
