  ...
  return createPortal(
    <>
      ...
      >
        ...
        >
          {/* St. Joseph's Placements and Training Cell logo — links to home */}
          <Link
            href="/dash"
              ...
              <div className="flex items-center gap-3 px-4 py-3.5">
                {planMeetsRequirement(plan, 'standard') && org?.logo_image ? (
                  ...
                  <div className="h-7 w-7 flex items-center justify-center bg-white/[0.06] rounded-lg">
                    <img src="/lrn-dash.svg" alt="St. Joseph's Placements and Training Cell" className="h-4 w-4" style={{ filter: 'brightness(0) invert(1)' }} />
                  </div>
                )}
