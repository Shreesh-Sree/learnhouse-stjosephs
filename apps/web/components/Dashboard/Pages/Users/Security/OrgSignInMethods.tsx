          ...
          <div className="min-w-0 pt-4">
            <Label htmlFor="central-session-sharing" className="cursor-pointer">
              {t('dashboard.organization.security.session_sharing_label', {
                defaultValue: 'Allow sharing sessions across organizations',
              })}
            </Label>
            <p className="text-xs text-gray-500 mt-0.5 leading-relaxed max-w-xl">
              {t('dashboard.organization.security.session_sharing_hint', {
                defaultValue:
                  'When off, a session started elsewhere on this platform won’t let members into this org — they must sign in again from this org’s login page using an allowed method.',
              })}
            </p>
          </div>
          <Switch
