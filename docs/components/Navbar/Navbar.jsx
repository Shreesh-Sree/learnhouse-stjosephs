    ...
    <>
        ...
        <div className="lh-navbar-inner">
          ...
          <div className="lh-navbar-left">
            <Link href="/" className="lh-navbar-logo">
              {mounted ? (
                <img src={logoSrc} alt="St. Joseph's Placements and Training Cell" />
              ) : (
          ...
          <div className="lh-navbar-right">
            ...
            <a
              href="https://github.com/Shreesh-Sree/learnhouse-stjosephs"
              target="_blank"
      ...
      <div className={`lh-mobile-drawer ${mobileMenuOpen ? 'lh-mobile-drawer-open' : ''}`}>
        <div className="lh-mobile-drawer-links">
          ...
          <a href="https://github.com/Shreesh-Sree/learnhouse-stjosephs" target="_blank" rel="noopener noreferrer" className="lh-mobile-drawer-link">
            <GithubLogo size={16} weight="fill" />
            GitHub
          </a>
        </div>
