  ...
  index: [
    {
      ...
      desc: "Ship your own headless learning platform with Next.js and the St. Joseph's Placements and Training Cell API — anonymous browsing first, then auth, enrollment and progress.",
    },
    {
      ...
      desc: "Drive the API with tokens, automate with webhooks, and extend St. Joseph's Placements and Training Cell with your own integrations.",
    },
  ],
