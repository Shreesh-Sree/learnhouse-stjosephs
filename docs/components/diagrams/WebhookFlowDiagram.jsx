...
const nodes = [
  ...
  { label: "St. Joseph's Placements and Training Cell API", sub: 'HMAC-SHA256 over body', icon: Cube, color: '#10b981', bg: '#ecfdf5', border: '#a7f3d0',
...
export default function WebhookFlowDiagram() {
  return (
    <FlowDiagram
      nodes={nodes}
      caption="Recompute the HMAC-SHA256 of the raw request body with your endpoint secret and compare it to X-Webhook-Signature before trusting the payload. If your endpoint doesn't return a 2xx, St. Joseph's Placements and Training Cell retries — up to 3 attempts, waiting 1s then 4s between them."
    />
  )
}
