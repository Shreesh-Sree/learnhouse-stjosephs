...
// Browser → your Next.js app (BFF) → St. Joseph's Placements and Training Cell API. Media streams straight
...
const nodes = [
  ...
  { label: "St. Joseph's Placements and Training Cell API", sub: '/api/v1', icon: Cube, color: '#10b981', bg: '#ecfdf5', border: '#a7f3d0' },
]
