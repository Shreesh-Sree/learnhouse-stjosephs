...
description: Extend St. Joseph's Placements and Training Cell beyond the official frontend — authenticate with API tokens, create and query content programmatically, and react to events with webhooks.
---
...
The [build guide](/guides/build-learning-platform) showed how to *read* the API as a frontend. This guide is about going further: driving St. Joseph's Placements and Training Cell **programmatically** — creating and managing content from your own scripts and services, and reacting to what happens inside St. Joseph's Placements and Training Cell with **webhooks**.
