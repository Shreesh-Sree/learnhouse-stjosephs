...
- **Auto User Provisioning** — Automatically creates St. Joseph's Placements and Training Cell accounts from IdP profiles.
...
2. Set the `WORKOS_API_KEY` and `WORKOS_CLIENT_ID` environment variables in your St. Joseph's Placements and Training Cell deployment.
