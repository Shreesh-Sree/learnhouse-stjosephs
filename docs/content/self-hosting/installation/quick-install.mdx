...
Follow these steps to install and start a self-hosted St. Joseph's Placements and Training Cell instance using the St. Joseph's Placements and Training Cell CLI.
...
## Step 2: Start St. Joseph's Placements and Training Cell
...
## Step 3: Access St. Joseph's Placements and Training Cell

Once all services are running, access St. Joseph's Placements and Training Cell at your configured domain or:
