...
Before installing St. Joseph's Placements and Training Cell, ensure your server meets the following requirements.
...
| Node.js | 18+ | Required to run the St. Joseph's Placements and Training Cell CLI |
...
St. Joseph's Placements and Training Cell is supported on:
