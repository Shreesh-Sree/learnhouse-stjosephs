...
Complete reference for all St. Joseph's Placements and Training Cell CLI commands. The CLI is published as `learnhouse` on npm and is typically run via `npx learnhouse@latest`.
...
Start all St. Joseph's Placements and Training Cell services. On first run, this pulls the required Docker images before starting containers.
...
Stop all running St. Joseph's Placements and Training Cell services. Data is preserved in Docker volumes.
...
Show the status of each St. Joseph's Placements and Training Cell service.
...
Update St. Joseph's Placements and Training Cell to the latest release or a specific version. Pulls the target image, rewrites `docker-compose.yml`, restarts services, and prompts for database migrations.
...
Run diagnostics on your St. Joseph's Placements and Training Cell installation. Checks Docker availability, container health, port conflicts, DNS resolution, and disk space.
...
Manage deployments and scale memory limits for your St. Joseph's Placements and Training Cell containers.
