...
St. Joseph's Placements and Training Cell supports two storage backends for uploaded content such as images, videos, and documents.
...
If you want S3-compatible storage without relying on a cloud provider, you can run MinIO alongside St. Joseph's Placements and Training Cell. MinIO provides an S3-compatible API on your own infrastructure.
