...
# Self-Hosting St. Joseph's Placements and Training Cell

St. Joseph's Placements and Training Cell can be self-hosted on your own infrastructure using the **St. Joseph's Placements and Training Cell CLI**. The CLI handles everything from initial setup to ongoing maintenance, including Docker Compose generation, environment file management, service orchestration, backups, and health checks.
...
St. Joseph's Placements and Training Cell will be available at **http://localhost** (or your configured domain). Log in with the admin credentials you provided during setup.
