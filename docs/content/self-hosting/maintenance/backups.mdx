...
Regular backups are essential for protecting your St. Joseph's Placements and Training Cell data. The St. Joseph's Placements and Training Cell CLI provides built-in backup and restore commands for the PostgreSQL database.
...
- **`database.sql`** — a `pg_dump` of the St. Joseph's Placements and Training Cell PostgreSQL database
