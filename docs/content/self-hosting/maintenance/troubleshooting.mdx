...
This guide covers common issues with self-hosted St. Joseph's Placements and Training Cell instances and how to resolve them.
...
- **Insufficient memory.** St. Joseph's Placements and Training Cell requires at least 2 GB of RAM. Check available memory with `free -m` (Linux) or Activity Monitor (macOS).
...
Stop the conflicting service, or reconfigure St. Joseph's Placements and Training Cell to use a different port by re-running `learnhouse setup`.
...
2. Check the [St. Joseph's Placements and Training Cell GitHub issues](https://github.com/learnhouse/learnhouse/issues) for known problems and solutions.
