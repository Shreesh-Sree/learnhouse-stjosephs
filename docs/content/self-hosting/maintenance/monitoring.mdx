...
Monitoring your self-hosted St. Joseph's Placements and Training Cell instance helps you catch issues early and ensure a reliable experience for your users.
...
- St. Joseph's Placements and Training Cell requires at least 2 GB of RAM
...
- **Uptime monitoring** -- use an external service to check that your St. Joseph's Placements and Training Cell instance is accessible (e.g., monitor `http://your-domain/api/v1/health`)
