...
Full reference for all St. Joseph's Placements and Training Cell CLI commands.
...
Show the live status of each St. Joseph's Placements and Training Cell container.
...
Update St. Joseph's Placements and Training Cell to the latest release or a specific version. See [Updates](/self-hosting/maintenance/updates) for details.
...
Features:
- List all St. Joseph's Placements and Training Cell deployments with container status
...
Then check the [St. Joseph's Placements and Training Cell releases page](https://github.com/learnhouse/learnhouse/releases) and the [GitHub issues](https://github.com/learnhouse/learnhouse/issues) for your version before retrying.
