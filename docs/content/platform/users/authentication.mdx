...
St. Joseph's Placements and Training Cell supports multiple authentication methods to fit different deployment scenarios.

## Login Methods

- **Email and password** — the default authentication method for every St. Joseph's Placements and Training Cell instance.
