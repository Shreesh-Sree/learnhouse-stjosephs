...
export const API_BASE_URL = (
  process.env.LEARNHOUSE_API_URL || 'https://your-domain.example'
).replace(/\/$/, '')
...
export const API_GROUPS = [
  ...
  },
  {
    ...
    access: 'session',
    rightsBucket: null,
    description: "Register HTTP endpoints that receive event notifications from St. Joseph's Placements and Training Cell.",
  },
  {
    slug: 'headless',
    title: 'Headless',
